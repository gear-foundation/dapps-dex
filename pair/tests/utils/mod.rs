...
impl<'a> Pair<'a> {
    ...
    pub fn skim(&mut self, to: u64) -> PairRunResult<((u128, u128), u64)> {
        RunResult::new(
            self.0
                .send(FOREIGN_USER, Action::new(InnerAction::Skim(to.into()))),
            |event, (amount, to)| {
                assert_eq!(
                    event,
                    Event::Skim {
...
impl PairState<'_> {
    ...
    pub fn quote(self, swap_kind: SwapKind, amount: u128) -> StateReply<Result<u128, Error>> {
        self.query_state_with_argument(7, (swap_kind, amount))
    }
    ...
    pub fn calculate_out_amount(
        ...
        self.query_state_with_argument(8, (swap_kind, in_amount))
    }
    ...
    pub fn calculate_in_amount(
        ...
        self.query_state_with_argument(9, (swap_kind, out_amount))
    }
}
