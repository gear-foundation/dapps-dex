...
use math::U256PairTuple;
use primitive_types::U256;
use tx_manager::{TransactionGuard, TransactionManager};

pub use math::{calculate_in_amount, calculate_out_amount, quote};
    ...
    async fn add_liquidity(
        ...
        let amount = if self.reserve == (0, 0) {
            ...
            if optimal_amount_b <= desired_amount.1 {
                ...
                let optimal_amount_a = quote(desired_amount.1, (self.reserve.1, self.reserve.0))?;
