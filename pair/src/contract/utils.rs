...
pub fn send<T: Decode>(to: ActorId, payload: impl Encode) -> GstdResult<CodecMessageFuture<T>> {
...
pub async fn balance_of(token: ActorId, actor: ActorId) -> GstdResult<u128> {
